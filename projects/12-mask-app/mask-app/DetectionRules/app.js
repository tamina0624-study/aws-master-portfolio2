...
function saveKeywords() {
  ...
  showKeywordsButton.textContent =
    "キーワード表示";
...
function maskText(text) {
  ...
  // カスタム辞書
  result = maskCustomKeywords(result);
...
saveKeywordsButton.addEventListener(
  "click",
  saveKeywords
);

clearKeywordsButton.addEventListener(
  "click",
  clearKeywords
);

showKeywordsButton.addEventListener(
  "click",
  () => {
